...
-(id)initWithSize:(CGSize)size{
    ...
    if ((self = [super initWithSize:size])) {
        ...
        SKSpriteNode *background = [SKSpriteNode spriteNodeWithImageNamed:@"Background-1"];
        ...
        CGPoint layerPosition = CGPointMake(-TileWidth * NumColumns/2, -TileHeight*NumRows + self.size.height/5 + (TileWidth/10));
